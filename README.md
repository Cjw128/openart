...
当前开发版本：**v0.9.9-dev（2026-07-13）**

本仓库提供智能车主车与从车的 OpenART Plus 单文件视觉程序。v0.9.0 已补全双车候选颜色上报、RT1021 主控仲裁和两侧 `0x03` 最终颜色锁定链路；当前开发版面向实战脱机运行清理无效逻辑并降低每帧分配与绘制开销，同时修复远距离世界坐标回传变成负数的问题，纵向远距饱和值为 `300 cm`。
